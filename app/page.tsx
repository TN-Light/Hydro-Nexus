    ...
    <div className="min-h-screen bg-gradient-to-br from-cream-50 to-cream-100">
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto text-center max-w-screen-xl">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-soil-950 mb-4 sm:mb-6 leading-tight">
            Optimize Exotic Crop
            <br />
            <span className="text-green-700">Cultivation with AI</span>
          </h1>
          <p className="text-lg sm:text-xl text-soil-950/70 mb-6 sm:mb-8 max-w-full sm:max-w-2xl lg:max-w-3xl mx-auto px-4">
      ...
      <section id="features" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto max-w-screen-xl">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-soil-950 mb-4">
              Complete Hydroponic Management
            </h2>
            <p className="text-lg sm:text-xl text-soil-950/70 max-w-full sm:max-w-xl lg:max-w-2xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <Card className="border-green-100 hover:border-green-300 transition-colors">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-soil-950 text-lg sm:text-xl">Real-Time Monitoring</CardTitle>
            ...
            <Card className="border-green-100 hover:border-green-300 transition-colors">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-soil-950 text-lg sm:text-xl">Analytics Studio</CardTitle>
                <CardDescription className="text-sm sm:text-base">
            ...
            <Card className="border-green-100 hover:border-green-300 transition-colors">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-soil-950 text-lg sm:text-xl">Digital Twin</CardTitle>
                <CardDescription className="text-sm sm:text-base">
            ...
            <Card className="border-green-100 hover:border-green-300 transition-colors">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-soil-950 text-lg sm:text-xl">Mobile PWA</CardTitle>
                <CardDescription className="text-sm sm:text-base">
            ...
            <Card className="border-green-100 hover:border-green-300 transition-colors">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-soil-950 text-lg sm:text-xl">Device Management</CardTitle>
                <CardDescription className="text-sm sm:text-base">
            ...
            <Card className="border-green-100 hover:border-green-300 transition-colors">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-soil-950 text-lg sm:text-xl">AI Optimization</CardTitle>
                <CardDescription className="text-sm sm:text-base">
        ...
        <div className="container mx-auto max-w-screen-xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-soil-950 mb-4 sm:mb-6">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-soil-950 mb-2 text-lg sm:text-xl">30% Higher Yields</h3>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-soil-950 mb-2 text-lg sm:text-xl">50% Water Savings</h3>
                    <p className="text-soil-950/70 text-sm sm:text-base">
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-soil-950 mb-2 text-lg sm:text-xl">24/7 Monitoring</h3>
                    <p className="text-soil-950/70 text-sm sm:text-base">
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl max-w-md mx-auto lg:max-w-none">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-green-700 mb-2">6.2</div>
                    <div className="text-xs sm:text-sm text-soil-950/70">pH Level</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-green-700 mb-2">24°C</div>
                    <div className="text-xs sm:text-sm text-soil-950/70">Water Temp</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-green-700 mb-2">2.1</div>
                    <div className="text-xs sm:text-sm text-soil-950/70">EC (mS/cm)</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-green-700 mb-2">7.2</div>
                    <div className="text-xs sm:text-sm text-soil-950/70">DO (mg/L)</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Footer */}
      <footer className="bg-white border-t py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-screen-xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            <div className="sm:col-span-2 md:col-span-1">
              <div className="flex items-center space-x-2 mb-4">
                <Leaf className="h-5 w-5 sm:h-6 sm:w-6 text-green-700" />
                <span className="text-lg sm:text-xl font-bold text-soil-950">Hydro Nexus</span>
              </div>
              <p className="text-soil-950/70 text-sm sm:text-base">
            ...
            <div>
              <h3 className="font-semibold text-soil-950 mb-4 text-base sm:text-lg">Platform</h3>
              <ul className="space-y-2 text-soil-950/70 text-sm sm:text-base">
                <li>
            ...
            <div>
              <h3 className="font-semibold text-soil-950 mb-4 text-base sm:text-lg">Resources</h3>
              <ul className="space-y-2 text-soil-950/70 text-sm sm:text-base">
                <li>
            ...
            <div>
              <h3 className="font-semibold text-soil-950 mb-4 text-base sm:text-lg">Company</h3>
              <ul className="space-y-2 text-soil-950/70 text-sm sm:text-base">
                <li>
                  <a href="#" className="hover:text-green-700 transition-colors">
                    About
          ...
          <div className="border-t mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-soil-950/70 text-sm sm:text-base">
