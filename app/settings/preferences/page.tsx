    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <Card>
        <CardHeader className="p-4 sm:p-6">
          ...
          <CardDescription className="text-sm sm:text-base">Choose your preferred application theme</CardDescription>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent className="p-4 sm:p-6 pt-0 space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3">
            <Label className="text-sm sm:text-base font-medium">Temperature</Label>
            <RadioGroup
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="celsius" className="text-sm sm:text-base">
                  Celsius (°C)
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="F" id="fahrenheit" />
                <Label htmlFor="fahrenheit" className="text-sm sm:text-base">
                  Fahrenheit (°F)
                </Label>
              </div>
            </RadioGroup>
          ...
          {/* Concentration Units */}
          <div className="space-y-3">
            <Label className="text-sm sm:text-base font-medium">Nutrient Concentration</Label>
            <RadioGroup
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="ppm" className="text-sm sm:text-base">
                  Parts Per Million (ppm)
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="mS/cm" id="ec" />
                <Label htmlFor="ec" className="text-sm sm:text-base">
      ...
      <Card>
        ...
        <CardContent className="p-4 sm:p-6 pt-0">
          <div className="space-y-3">
            <Label htmlFor="dashboard-range" className="text-sm sm:text-base font-medium">
              Default Time Range
            </Label>
      ...
      <Card>
        <CardContent className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Button
              variant="outline"
              className="border-green-200 hover:border-green-400 bg-transparent w-full sm:w-auto"
